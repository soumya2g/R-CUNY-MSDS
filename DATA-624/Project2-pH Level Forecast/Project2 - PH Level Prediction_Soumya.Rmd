...
studentDF <- readxl::read_excel("StudentData.xlsx", skip=0)

str(studentDF)

studentDF %>% kable() %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>% scroll_box(width="100%",height="300px")
...
studentEvalDF <- readxl::read_excel("StudentEvaluation.xlsx", skip=0)

studentEvalDF %>% kable() %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>% scroll_box(width="100%",height="300px")
